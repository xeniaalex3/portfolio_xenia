...
function Contact() {
  ...
  return (
    <section
      className="2xl:w-[83rem] xl:w-[70rem] lg:w-[58rem] lg:h-[26rem] md:w-[39rem] md:h-[52rem] xs:h-[48rem] sm:w-[23rem] xs:w-[22rem] bg-[var(--surface-primary)] mx-auto mt-[13rem] mb-[7rem] flex items-center lg:justify-between md:justify-evenly lg:flex-row md:flex-col xs:flex-col shadow-lg rounded-lg gap-9"
      id="contact"
    >
      <div className="flex flex-col gap-4 lg:w-2/5 md:w-[96%] px-10 md:mt-0 xs:mt-[2rem]">
      ...
      <div className="lg:w-[47%] md:w-[96%] xs:w-[100%] flex flex-col gap-2">
        <form
