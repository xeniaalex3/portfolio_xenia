...
function Skills() {
  return (
    <section className="flex flex-col justify-center items-center 2xl:w-[83rem] xl:w-[70rem] lg:w-[55rem] mx-auto mb-[8rem] md:w-[39rem] sm:w-[23rem] xs:w-[22rem]" id="skills">
      <h2 className="text-[var(--secondary-color)] font-semibold text-3xl mb-18">
        Skills
      </h2>
      <div className="grid xl:grid-cols-3 lg:grid-cols-2 2xl:gap-x-26 xl:gap-x-15 lg:gap-x-9 md:grid-cols-1 xl:gap-y-0 lg:gap-y-9 md:gap-y-16 xs:gap-y-14">
